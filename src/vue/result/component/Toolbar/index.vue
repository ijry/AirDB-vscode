  ...
  <div class="toolbar" style="display: flex;justify-content: space-between;align-items: center;">
    <div class="left" style="flex: 1;">
       <el-button v-if="showFullBtn" @click="()=>$emit('sendToVscode','full')"
        ...
        <el-button icon="el-icon-circle-plus-outline"
          @click="$emit('insert')" :title="$t('Insert new row')"></el-button>
        <el-button icon="el-icon-delete" style="color:#f56c6c"
          @click="$emit('deleteConfirm');" :title="$t('delete')"></el-button>
        <el-button icon="el-icon-bottom" @click="$emit('export');"
          style="color:#4ba3ff;" title="Export"></el-button>
        <el-button icon="el-icon-caret-right" :title="$t('Execute Sql')"
          style="color: #54ea54;margin-left:0;" @click="$emit('run');"></el-button>
    ...
    <div class="right" style="padding-right: 10px;">
      <el-pagination @size-change="changePageSize"
        ...
        :small="true" :page-size="page.pageSize"
