...
export class TableGroup extends Node {
    ...
    constructor(readonly parent: Node) {
        ...
        if (parent.dbType == DatabaseType.MYSQL || parent.dbType == DatabaseType.ORACLE || parent.dbType == DatabaseType.DAMENG || parent.dbType == DatabaseType.CLICKHOUSE || parent.dbType == DatabaseType.DORIS || parent.dbType == DatabaseType.TDENGINE) {
    ...
    public async updatePinedTables() {
        if (this.isCloud) {
            ...
            let pinedTablesMap = {}
            if (this.dbType == DatabaseType.MYSQL || this.dbType == DatabaseType.ORACLE || this.dbType == DatabaseType.DAMENG || this.dbType == DatabaseType.CLICKHOUSE || this.dbType == DatabaseType.DORIS || this.dbType == DatabaseType.TDENGINE) {
                // @ts-ignore
