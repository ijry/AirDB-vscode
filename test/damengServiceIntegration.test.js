...
mockModule("src/service/dump/kingbaseDumpService.ts", {
  KingbaseDumpService: EmptyDisposableProvider,
});
...
mockModule("src/service/import/kingbaseImportService.ts", {
  KingbaseImportService: EmptyDisposableProvider,
});
...
const { DamengImportService } = requireTs("src/service/import/damengImportService.ts");
const { DamengDumpService } = requireTs("src/service/dump/damengDumpService.ts");
...
console.log("damengServiceIntegration tests passed");
