...
const { KingbaseImportService } = requireTs("src/service/import/kingbaseImportService.ts");
const { KingbaseDumpService } = requireTs("src/service/dump/kingbaseDumpService.ts");
...
console.log("kingbaseImportExportRegistration tests passed");
